...
namespace OpenBLive.Runtime
{
    ...
    public abstract class BLiveClient : IDisposable
    {
        ...
        /// 带有重连
        /// </summary>
        public abstract Task<bool> Connect(TimeSpan timeout);
        ...
        [RequiresUnreferencedCode("Calls System.Text.Json.JsonConvert.DeserializeObject<TValue>(String, JsonSerializerOptions)")]
        private void ProcessNotice(string rawMessage)
        {
            var json = JsonNode.Parse(rawMessage);
